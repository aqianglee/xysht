...
public class GoodHandler {
	...
	public String list(Map<String, Object> map, Integer classfyId) {
		...
		map.put("classfies", classfyService.getClassfiesByParent(
	...
	public String save(Map<String, Object> map, Good good, Integer[] tagsId,
		...
		if (errorMessages.size() == 0) {
			...
			return "redirect:/shopKeeper/getGoodsByClassfy?classfyId="
					+ good.getClassfy().getId();
		} else {
			map.put("classfy",
					classfyService.findEntity(good.getClassfy().getId()));
			map.put("tags", tagService.getAllTags());
