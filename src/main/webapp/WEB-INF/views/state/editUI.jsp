...
<script type="text/javascript" src="${pageContext.request.contextPath }/script/menu.js"></script>"></script>
</head>
<body>
	<header>
	...
	<div class="context">
		...
		<div class="right">
			...
			<div align="center">
				<form:form action="${pageContext.request.contextPath }/shopKeeper/saveState" method="post" modelAttribute="state">
					<span class="errorInfo">${actionError } </span>
					<table>
						<form:hidden path="id"/>
						<tr>
							<td align="right"><label>订单状态名称：</label></td>
							<td>
								<form:input path="name" class="textFiled"/>
								<span class="errorInfo"><form:errors path="name"/> </span>
							</td>
						</tr>
					</table>
					<br>
